...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        String text = manager.fileToText("/home/alejandroperalta/workspace/my-repos/plant-uml-generator/src/main/java/klass/Argument.java");
        Klass klass = reader.readKlass(text);

        UMLMaker maker = new UMLMaker();
        Set<String> lines = maker.makeClassUml(klass);
